...
export default class SingleProject extends Component {
    constructor(props){
        ...
        this.handelMarkTaskAsCompleted = this.handelMarkTaskAsCompleted.bind(this)
    }
    ...
    handelMarkTaskAsCompleted(taskId){
    ...
    componentDidMount(){
        const projectId = this.props.math.params.id
                                ...
                                <ul className="list-group mt-3">
                                    {tasks.map(task => {
                                        ...
                                        >
                                            ...
                                            <button className="btn btn-primary btn-sm"
                                                onClick={this.handelMarkTaskAsCompleted}>
